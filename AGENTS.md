...
4. **Språkgranskning av skärmtexter (obligatorisk gate innan commit):**
   Designagenten samlar alla "Text på skärmen"-fält och feedbacktexter ur design.md och formulerar prompter till användaren:
   ...
   - Designagenten reviderar texterna i design.md baserat på svaren. Texterna i design.md är sedan **låst kopia** som kopieras ordagrant vid implementation.
